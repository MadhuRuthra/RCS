...
// ApprovercsNoApiList Function - start
async function ApprovercsNoApiList(req) {
 ...
 //  Get all the req header data
		...
		var whrcondition = ` `;
// query parameters
		logger_all.info("[ApprovercsNoApiList query parameters] : " + JSON.stringify(req.body));
// To get the User_id
...
//  admin - dept head are following this to get the userid is act to parent_id
    ...
    // to get_approve_rcs_no_api using
      ...
      // get_approve_rcs_no_api length is '0' to through the no data available message. 
		...
		logger_all.info("[ApprovercsNoApiList failed response] : " + e)
		return { response_code: 0, response_status: 201, response_msg: 'Error occured' };
	}
}
// ApprovercsNoApiList Function - end
