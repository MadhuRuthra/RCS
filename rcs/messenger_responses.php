...
<body>
 ...
 console.log(txt_reply,message_id,message_from,message_to)
var message_id = encodeURIComponent(message_id);
var message_from = encodeURIComponent(message_from);
var message_to = encodeURIComponent(message_to);
    ...
    data: {
        tmpl_call_function: 'view_response',
  ...
  var txt_reply,message_id,message_from,message_to;
