  ...
  <div id="app">
    <section class="section">
      <div class="mt-5">
        <div class="row">
          <!-- Signin - Start -->
          <div class="col-12" id="tab_signin" style="display:block">
            <div class="login-brand col-sm-12 col-md-5" style="float: left">
              <img src="assets/img/YeeJai_Logo.png" alt="logo" style="width: 75%">
            </div>
              ...
              <div class="card-body">
                <form class="md-float-material form-material" action="#" name="frm_login" id='frm_login' method="post">
                  <div>
                        ...
                        <div class="input-group" title="Visible Password">
                          ...
                          <div class="input-group-prepend">
                            <div class="input-group-text" onclick="password_visible1()"
                              id="id_signup_display_visiblitity"><i class="fas fa-eye-slash"></i></div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row  mt-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="hidden" class="form-control" name='hid_sendurl' id='hid_sendurl'
                          value='<? $server_http_referer = $site_url . "dashboard";
                          echo $server_http_referer; ?>' />
                    ...
                    <!-- <a class="nav-link" href="onboarding"> New Users : Sign up</a> -->
                  </div>
              </div>
        ...
        <form class="needs-validation" novalidate action="#" name="frm_signup" id='frm_signup'
          ...
          <div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="clientname_txt" id="clientname_txt" class="form-control" value=""
                  maxlength="50" tabindex="1" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Client Name" placeholder="Client Name" pattern="[a-zA-Z0-9 -_]+"
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="contact_person_txt" id="contact_person_txt" class="form-control" value=""
                  maxlength="50" tabindex="2" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title=" Contact person" placeholder="Contact person" pattern="[a-zA-Z0-9 -_]+"
                  onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
              </div>
            </div>
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="designation_txt" id="designation_txt" class="form-control" value=""
                  maxlength="100" tabindex="3" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Contact person designation" placeholder="Contact person designation"
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="mobile_no_txt" id="mobile_no_txt" class="form-control" value="" maxlength="10"
                  tabindex="4" autofocus="" required="" data-toggle="tooltip" data-placement="top" title=""
                  data-original-title="Contact person Contact no" placeholder="Contact person Contact no"
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="email_id_contact" id="email_id_contact" class="form-control" value=""
                  maxlength="100" tabindex="5" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Contact person Email ID" placeholder="Contact person Email ID">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <input type="text" name="bill_address" id="bill_address" class="form-control" value="" maxlength="100"
                  tabindex="6" autofocus="" required="" data-toggle="tooltip" data-placement="top" title=""
                  data-original-title="Billing Address & GST" placeholder="Billing Address & GST"
                  pattern="[a-zA-Z0-9 -_]+">
              </div>
            </div>

            </br></br>
            <h5 class="text-center"><i class="icofont icofont-sign-in"></i>Company Information </h5></br>
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="business_name" id="business_name" class="form-control" value="" maxlength="100"
                  tabindex="7" autofocus="" required="" data-toggle="tooltip" data-placement="top" title=""
                  data-original-title="company name" placeholder="Company name" pattern="[a-zA-Z0-9 -_]+"
                  onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
              </div>
            </div>
            <div class="row mt-2">
              ...
              <div class="col-6">
                <textarea type="text" name="cpy_website_details" id="cpy_website_details" class="form-control" value=""
                  maxlength="256" tabindex="8" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Company website details" placeholder="Company website details"
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="parent_company_name" id="parent_company_name" class="form-control" value=""
                  maxlength="100" tabindex="9" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Parents company name" placeholder="Parents company name"
                  pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)" onpaste="return false;">
              </div>
            </div>
            <div class="row mt-2">
              ...
              <div class="col-6">
                <textarea type="text" name="cpy_display_name" id="cpy_display_name" class="form-control" value=""
                  maxlength="255" tabindex="10" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Group company name" placeholder="Company display name"
                  pattern="[a-zA-Z0-9 -_]+" onkeypress="return clsAlphaNoOnly(event)"
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <textarea type="text" name="desp_business_txt" id="desp_business_txt" class="form-control" value=""
                  maxlength="512" tabindex="11" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Description of the business"
                  placeholder="Description of the business"></textarea>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <textarea type="text" name="reg_add_business" id="reg_add_business" class="form-control" value=""
                  maxlength="256" tabindex="12" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Official addres" placeholder=" Registered Address of the business"
                  pattern="[a-zA-Z0-9 -_]+"></textarea>
              </div>
            </div>

            </br></br>
            <h5 class="text-center"><i class="icofont icofont-sign-in"></i>Communication Information </h5></br>
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="email_id_txt" id="email_id_txt" class="form-control" value="" maxlength="128"
                  tabindex="13" autofocus="" required="" data-toggle="tooltip" data-placement="top" title=""
                  data-original-title=" Official Email ID" placeholder=" Email ID">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <input type="text" name="contact_no_cmpy" id="contact_no_cmpy" class="form-control" value=""
                  maxlength="10" tabindex="14" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Business contact no" placeholder="Contact no"
                  onkeypress="return (event.charCode !=8 && event.charCode ==0 ||  (event.charCode >= 48 && event.charCode <= 57))">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
                Profile/ Display picture of the business<label style="color:#FF0000">*</label>
              </div>
              <div class="col-6">
                <input type="file" name="profile_display_pic" id="profile_display_pic" class="form-control" value=""
                  maxlength="100" tabindex="15" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title=""
                  data-original-title=" Profile/ Display picture of the business - Allowed only jpeg, png images. Maximum 5 MB Size allowed"
                  placeholder="Profile/ Display picture of the business" accept="image/png, image/jpeg">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <select name="slt_service_category" required="" id='slt_service_category' class="form-control"
                  data-toggle="tooltip" data-placement="top" title="" data-original-title="Select Service Category"
                  tabindex="16">
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="sender_id_txt" id="sender_id_txt" class="form-control" value="" maxlength="10"
                onkeypress="return (event.charCode == 0 || (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 8)"
                  tabindex="17" autofocus="" required="" data-toggle="tooltip" data-placement="top" title=""
                  data-original-title="Recommend fresh no or never used whatsapp" placeholder="Sender ID">
              </div>
            </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <textarea type="text" name="sender_id_txt_1_txt" id="sender_id_txt_1_txt" class="form-control" value=""
                  maxlength="1024" tabindex="18" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title=""
                  data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters."
                  placeholder="Sender ID 1 "></textarea>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
              <input type="text" name="sender_id_2_txt" id="sender_id_2_txt" class="form-control" value=""
       maxlength="10"
       onkeypress="return (event.charCode == 0 || (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 8)"
       tabindex="17" autofocus="" required=""
       data-toggle="tooltip" data-placement="top" title=""
       data-original-title="Recommend fresh no or never used whatsapp" placeholder="Sender ID 2">
              </div>
            </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <textarea type="text" name="sender_id_txt_2_txt" id="sender_id_txt_2_txt" class="form-control" value=""
                  maxlength="1024" tabindex="19" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title=""
                  data-original-title="Message script / template. This message will send from this sender id. Maximum 1024 characters."
                  placeholder="Sender ID 2"></textarea>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <select class="form-select form-control" required="" aria-label="Default select example" tabindex="20"
                  id="type_of_message" name="type_of_message">
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <select class="form-select form-control" required="" aria-label="Default select example" tabindex="21"
                  id="otp_in_process" name="otp_in_process">
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="text" name="enquiry_approve_txt" id="enquiry_approve_txt" class="form-control" value=""
                  maxlength="100" tabindex="22" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Enquiry/ Approval page" placeholder="Enquiry/ Approval page">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <input type="text" name="privacy_terms_txt" id="privacy_terms_txt" class="form-control" value=""
                  maxlength="100" tabindex="23" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Privacy & terms of service page"
                  placeholder="Privacy & terms of service page">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <input type="text" name="terms_condition_txt" id="terms_condition_txt" class="form-control" value=""
                  maxlength="100" tabindex="24" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Official T&C page" placeholder="Terms & Condition page">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <select class="form-select form-control" required="" aria-label="Default select example" tabindex="25"
                  id="proof_document_slt" name="proof_document_slt">
            ...
            <div class="row mt-2">
              ...
              <div class="col-6">
                <input type="file" name="proof_document" id="proof_document" class="form-control" value=""
                  maxlength="100" tabindex="26" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title=" Proof of document - Allowed only PDF files" accept="application/pdf"
                  placeholder=" Proof of document (Upload PDF)">
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-6 label">
              ...
              <div class="col-6">
                <input type="text" name="expected_volumes_day" id="expected_volumes_day" class="form-control" value=""
                  maxlength="100" tabindex="27" autofocus="" required="" data-toggle="tooltip" data-placement="top"
                  title="" data-original-title="Expected volumes for day" placeholder="50000 per day"
...
// Looping the indicator is less than the num_of_rows.if the condition is true to continue the process and to get the details.if the condition are false to stop the process
  ...
  <div class="simple-footer" style="margin-top: 240px;">
    Copyright &copy;
    <?= $site_title ?> -
    <?= date("Y") ?>
  </div>
  ...
  <script>
    ...
    $(document).on("submit", "form#frm_signup", function (e) {
      ...
      var sender_id_2_txt = $('#sender_id_2_txt').val();
      ...
      if (sender_id_2_txt == "") {
        $('#sender_id_2_txt').css('border-color', 'red');
        flag = false;
      }
      ...
      var sender_id_txt = document.getElementById('sender_id2_txt').value;
      if (sender_id_txt.length != 10) {
        $("#id_error_display_onboarding").html("Please enter a valid mobile number");
        flag = false;
        document.getElementById('sender_id2_txt').focus();
      }
      if (!(sender_id_txt.charAt(0) == "9" || sender_id_txt.charAt(0) == "8" || sender_id_txt.charAt(0) == "6" || sender_id_txt.charAt(0) == "7")) {
        $("#id_error_display_onboarding").html("Please enter a valid mobile number");
        document.getElementById('sender_id2_txt').focus();
